...
export const badgeHover = () => <BadgeHover title={badges[0].name} requirement={badges[0].requirement} classId={4} />
...
const badges = [
  {
    "id": 1,
    "name": "Master Chef",
    "image": "https://d1nhio0ox7pgb.cloudfront.net/_img/g_collection_png/standard/256x256/medal.png",
