...
module.exports = () => {
  router.post("/users/edit", (req, res) => {
    ...
    if (!confirmChangePassword) {
      console.log(
        "Please input your password to change your account settings."
      );
      res
        .status(401)
        .send("Please input your password to change your account settings.");
    } else {
        ...
        if (user) {
          if (password) {
            if (password === confirmPassword) {
              ...
              res
                .status(401)
                .send("New password does not match the confirm password.");
            }
          } else {
